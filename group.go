...
func (coolq *CoolQ) SendGroupMsg(GourpID int, Message string, IsRaw bool) error {
	// send_private_msg
	err, _ := coolq.httpPOST("/send_group_msg", CoolQMap{
		"group_id": GourpID,
		"message":  Message,
		"is_raw":   IsRaw,
	})
...
func (coolq *CoolQ) GetGroupMemberList(GroupID int) (*GroupMmeberList, error) {
	err, info := coolq.httpPOST("/get_group_member_list", CoolQMap{
		"group_id": GroupID,
	})
	if err != nil {
		return nil, err
...
func (coolq *CoolQ) GetGroupMemberInfo(GroupID, UserID int, NoCache bool) (*GroupMemberInfo, error) {
	err, info := coolq.httpPOST("/get_group_member_info", CoolQMap{
		"group_id": GroupID,
		"user_id":  UserID,
		"no_cache": NoCache,
	})
...
func (coolq *CoolQ) SetGroupKick(GroupID, UserID int, AddRequest bool) error {
	err, _ := coolq.httpPOST("/set_group_kick", CoolQMap{
		"group_id":           GroupID,
		"user_id":            UserID,
...
func (coolq *CoolQ) SetGroupUserBan(GroupID, UserID, Time int) error {
	err, _ := coolq.httpPOST("/set_group_ban", CoolQMap{
		"group_id": GroupID,
		"user_id":  UserID,
		"duration": Time,
	})
...
func (coolq *CoolQ) SetGroupUserAnonymousBan(GroupID int, Flag string, Time int) error {
	err, _ := coolq.httpPOST("/set_group_anonymous_ban", CoolQMap{
		"group_id": GroupID,
		"flag":     Flag,
		"duration": Time,
	})
...
func (coolq *CoolQ) SetGroupBan(GroupID int, Enable bool) error {
	err, _ := coolq.httpPOST("/set_group_whole_ban", CoolQMap{
		"group_id": GroupID,
		"enable":   Enable,
	})
	return err
...
func (coolq *CoolQ) SetGroupAdmin(GroupID, UserID int, Enable bool) error {
	err, _ := coolq.httpPOST("/set_group_admin", CoolQMap{
		"group_id": GroupID,
		"user_id":  UserID,
		"enable":   Enable,
	})
...
func (coolq *CoolQ) SetGroupAnonymous(GroupID int, Enable bool) error {
	err, _ := coolq.httpPOST("/set_group_anonymous", CoolQMap{
		"group_id": GroupID,
		"enable":   Enable,
	})
	return err
...
func (coolq *CoolQ) SetGroupCard(GroupID, UserID int, Card string) error {
	err, _ := coolq.httpPOST("/set_group_card", CoolQMap{
		"group_id": GroupID,
		"user_id":  UserID,
		"card":     Card,
	})
...
func (coolq *CoolQ) SetGroupTitle(GroupID, UserID int, Title string, Duration int) error {
	err, _ := coolq.httpPOST("/set_group_special_title", CoolQMap{
		"group_id":      GroupID,
		"user_id":       UserID,
		"special_title": Title,
		"duration":      Duration,
...
func (coolq *CoolQ) LeaveGroup(GroupID int, IsDismiss bool) error {
	err, _ := coolq.httpPOST("/set_group_leave", CoolQMap{
		"group_id":   GroupID,
...
func (coolq *CoolQ) SetGroupRequest(Flag, Type string, Approve bool, Reason string) error {
	err, _ := coolq.httpPOST("/set_group_add_request", CoolQMap{
		"flag":    Flag,
		"type":    Type,
		"approve": Approve,
		"reason":  Reason,
